...
class NetworkConnection {
	...
	setupDefaultDataSubscriptions() {
		...
		this.dataChannelSubs[ReservedDataType.Update] = this.entities.updateEntity.bind(
			this.entities,
		);

		this.dataChannelSubs[ReservedDataType.UpdateMulti] = this.entities.updateEntityMulti.bind(
			this.entities,
		);

		this.dataChannelSubs[ReservedDataType.Remove] = this.entities.removeRemoteEntity.bind(
			this.entities,
		);
	}
